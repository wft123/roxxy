...
<body>
	<div class="container">
		...
		<div class="content">
			<div id="notice">
				<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/notice/modify" enctype="multipart/form-data">
				...
				<legend>글수정</legend>
					...
					<div class="form-group">
					    <div class="btn-group col-sm-offset-2 col-sm-10">
							<a href="${pageContext.request.contextPath}/notice/" class="btn btn-danger">취소</a>
