...
import com.hanains.mysite.dao.NoticeDao;
...
public class NoticeService {
	...
	public Map<String, Object> list(long page, String kwd, String searchType) {
		...
		long NoticeSize = dao.getNoticeSize(kwd, searchType);
		long startIndex = NoticeSize - ((page-1)*PAGE_SIZE);
		long totalPageSize = (long)Math.ceil((double)NoticeSize/PAGE_SIZE);
		...
		map.put("NoticeSize", dao.getNoticeSize(kwd, searchType));
	...
	public void modify(NoticeVo vo, MultipartFile file1) {
		if(!file1.isEmpty()){
	...
	public void write(NoticeVo vo, MultipartFile file1) {
		if(vo.getGroup_no()==0){
